...
public class ValhelsiaBiomeModifiers implements RegistryClass {
    ...
    public static final MappedRegistryHelper<Codec<? extends BiomeModifier>> HELPER = ValhelsiaCoreForge.REGISTRY_MANAGER.getHelper(NeoForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS);
