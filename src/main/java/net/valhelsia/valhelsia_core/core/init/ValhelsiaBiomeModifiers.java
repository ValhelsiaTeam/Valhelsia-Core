...
public class ValhelsiaBiomeModifiers implements RegistryClass {
    ...
    public static final RegistryHelper<Codec<? extends BiomeModifier>> HELPER = ValhelsiaCore.REGISTRY_MANAGER.getHelper(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS);
