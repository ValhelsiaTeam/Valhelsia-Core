 ...
 * @since 2021-10-27
 */
public class CosmeticsHandLayer<T extends AbstractClientPlayerEntity> extends LayerRenderer<T, PlayerModel<T>> {

    private final CosmeticsManager cosmeticsManager;
    private CosmeticsModel<T> model;

    public CosmeticsHandLayer(LivingRenderer<T, PlayerModel<T>> entityRenderer) {
