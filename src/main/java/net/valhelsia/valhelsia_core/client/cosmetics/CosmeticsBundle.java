...
public enum CosmeticsBundle {
    HALLOWEEN_2021_COLLECTION_BUNDLE("halloween_2021_collection_bundle", Arrays.asList("witchs_broom", "cauldron_backpack", "green_witchs_wand", "purple_witchs_wand", "green_witchs_hat", "purple_witchs_hat"));
