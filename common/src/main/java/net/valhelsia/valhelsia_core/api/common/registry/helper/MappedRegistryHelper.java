...
public abstract class MappedRegistryHelper<T> extends RegistryHelper<T, RegistryClass> {
    ...
    public <O extends T> RegistryEntry<O> register(String name, Supplier<O> object) {
        return this.registerInternal(name, object);
    }

    public <O extends T, E extends RegistryEntry<O>> E registerInternal(String name, Supplier<O> object) {
